...
render() {
    ...
    return (
        ...
        <TouchableOpacity style={styles.button1} onPress={() => this.props.navigation.navigate('SignUpPassword')}>
                <Text style={styles.textCreateAccount}>
                    Next
                </Text>
        </TouchableOpacity>

        <TouchableOpacity style={stylin} onPress={() => this.props.navigation.navigate('Login')}>
