...
class ImpactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create impact" do
    assert_difference('Impact.count') do
      post impacts_url, params: { impact: { feeling: @impact.feeling, impact_id: @impact.impact_id } }
    end
  ...
  test "should update impact" do
    patch impact_url(@impact), params: { impact: { feeling: @impact.feeling, impact_id: @impact.impact_id } }
