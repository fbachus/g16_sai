...
class FeedbacksTest < ApplicationSystemTestCase
  ...
  test "creating a Feedback" do
    ...
    fill_in "Action", with: @feedback.action
    fill_in "Anonymous", with: @feedback.anonymous
    fill_in "Feedback", with: @feedback.feedback_id
    fill_in "Impact", with: @feedback.impact_id
    fill_in "Situation", with: @feedback.situation
